...
// RegisterResolver registers a new user and returns true if it was successful and false otherwise
...
// AuthenticationResolver authenticates a user using their email and password and returns a JWT
...
// UserDetailsResolver sends back the details about a specific the user who sent the request
